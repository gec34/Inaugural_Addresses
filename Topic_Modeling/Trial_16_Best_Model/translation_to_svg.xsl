    ...
    <xsl:template match="/">
        <svg height="1000" width="2000">
           ...
           <xsl:for-each select="//line">
               ...
               <rect width="20" height="{$height}" fill="blue" stroke="black" stroke-width="1" x="{$placement}" y="{$y-placement}"></rect>
               <text x="{$placement}" y="820" fill="blue"><xsl:value-of select="data[1]"></xsl:value-of></text>
